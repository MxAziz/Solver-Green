...
export default function Sidebar({
  ...
  // This adjusts state during render (the pattern React recommends for
  // "resetting state when a prop changes") instead of doing it inside a
  // useEffect, which avoids the extra render pass / set-state-in-effect
  // warning that a synchronous setState in an effect body would trigger.
